...
namespace Geta.ImageOptimization
{
    ...
    public class ImageOptimizationJob : EPiServer.Scheduler.ScheduledJobBase
    {
        private bool _stop;
        ...
        {
            _logger.Log(Level.Error, "EXECUTING..."); 
            ...
            try { 
                ...
                foreach (ImageData image in allImages)
                {
                        ...
                        {
                            _logger.Trace("Continuing on... " + image.Name);
                            continue;
                        }
                        ...
                        {
                            _logger.Error("ErrorMessage from KrakenProxy: " + imageOptimizationResponse.ErrorMessage);
                        }
                    }
        ...
        }catch(System.Exception exception)
            {
                ...
                _logger.Log(Level.Error, exception.ToString());
                throw exception;
